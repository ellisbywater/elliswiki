          ...
          <div className="md:flex justify-between w-full">
            ...
            <div className="xl:w-4/6 md:w-1/2 w-full xl:pl-48">
              <p
                ...
                “Don’t get carried away with super-short paragraphs. The secret
                to one-sentence paragraphs is to use them like a spice: A pinch
                of cumin can make a meal more savory, but I don’t want to eat a
