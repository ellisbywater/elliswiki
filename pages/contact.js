              ...
              <div className="flex flex-col items-start xl:justify-start 2xl:justify-end xl:px-0 px-4">
                <div className="w-full 2xl:w-8/12 mt-3">
                  <div className="mt-4 md:mt-8">
                    ...
                    <input
                      className="mt-3 shadow-lg text-base rounded border-2 w-11/12 lg:w-full xl:w-10/12 hover:border-green-600 focus:border-green-600 focus:outline-none border-black py-5 pl-4 text-gray-800"
                      type="text"
                  ...
                  <div className="mt-4 md:mt-8">
                    ...
                    <textarea
                      className="mt-3 shadow-lg rounded text-base border-2 w-11/12 lg:w-full xl:w-10/12 resize-none hover:border-green-600 focus:border-greem-600 focus:outline-none border-black xl:h-40 py-5 pl-4 text-gray-800"
                      type="text"
                  ...
                  <div className="py-5">
                    <button className="py-3 shadow-lg rounded md:py-5 px-5 md:px-10 bg-gray-900 text-white hover:bg-black hover:shadow ease-in duration-150 text-sm md:text-lg tracking-wider font-semibold">
                      Send
                    </button>
                  </div>
                </div>
